...
Insert Into Users Values ('1','authlast_Name1', 'authfirst_Name1', 'street_Address1', 'city1', 'state1', 1, 'passwd1', 'passwd2', '08-Dec-03','1', '1',1);
Insert Into Users Values ('2','authlast_Name2', 'authfirst_Name2', 'street_Address2', 'city2', 'state2', 2, 'passwd1', 'passwd2', '08-Dec-03', '1','2',1);
Insert Into Users Values ('3','authlast_Name3', 'authfirst_Name3', 'street_Address3', 'city3', 'state3', 3, 'passwd1', 'passwd2', '08-Dec-03', '1','2',1);
Insert Into Users Values ('smith','mike', 'smith', 'street_Address4', 'city4', 'state4', 4, 'passwd1', 'passwd2', '08-Dec-03', '1','2',2);
...
Insert Into Users Values ('ford','ford'  , 'frank', 'street_Address7', 'city7', 'state7', 7, 'passwd1', 'passwd2', '08-Dec-03', '1','2', 3);
Insert Into Users Values ('mitchell','mitchell'  , 'olinga', 'street_Address8', 'city8', 'state8', 8, 'passwd1', 'passwd2', '08-Dec-03', '1','2', 3);
Insert Into Users Values ('9','adlast_Name9'  , 'adfirst_Name9', 'street_Address9', 'city9', 'state9', 9, 'passwd1', 'passwd2', '08-Dec-03', '1','2', 3);

Insert Into Admin Values ('ford');
Insert Into Admin Values ('mitchell');
Insert Into Admin Values ('9');

Insert Into Surgeons Values ('smith', 'heart');
...
Insert Into Auth_Personnel Values('smith','surgeon', '1');
Insert Into Auth_Personnel Values('5','surgeon', '1');
Insert Into Auth_Personnel Values('6','surgeon', '1'); 
Insert Into Auth_Personnel Values('ford','Admin', '1');
Insert Into Auth_Personnel Values('mitchell','Admin', '1');
