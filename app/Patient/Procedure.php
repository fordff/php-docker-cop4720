...
<form method="post" enctype="multipart/form-data" name="diag_entry" target="_self" id="diag_entry">
			<table width="34%"  border="0" cellpadding="3" cellspacing="3" class="border">
                <tr class="tbletitle">
                ...
                <tr>
				  ...
				  if (!isset($var_Diag_F))
				     $var_diag_select = 0;
				  $select = "*";
				  $from = "List_Procedure as D, Procedure_Tree as T";
				  $where = "(T.Parent_Proc = ".$var_diag_select." and T.Child_Proc = D.proc_list_id)";
			  ...
			  ?></td>
                ...
                <tr>
                  <td><input name="Diag_F" type="submit" id="Diag_F" value="Forward">
